...
class DCGenerator(nn.Module):
    def __init__(self, noise_size, conv_dim):
        ...
        self.deconv1 = deconv(noise_size, 128,4)
...
class DCDiscriminator(nn.Module):
    ...
    def __init__(self, conv_dim=64):
        ...
        self.conv1 = conv(3, 32, 4, padding=4)
        self.conv2 = conv(32, 64, 4, padding=4)
        self.conv3 = conv(64, 128, 4, padding=4)
        self.conv4 = conv(128, 1 , 4, padding=4)
